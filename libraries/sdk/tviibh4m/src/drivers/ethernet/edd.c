...
/****************************************************************************
* Modification by Infineon: For use within TRAVEO T2G Sample Driver Library
*****************************************************************************/
...
uint32_t CPS_UncachedRead32(volatile uint32_t* address) {
    /** Invalidate cache **/
    Cy_SysLib_InvalidateCoreDCacheByAddr((void*)address, 4);
...
void CPS_UncachedWrite32(volatile uint32_t* address, uint32_t value) {
    ...
    /** Clean cache **/
    Cy_SysLib_CleanCoreDCacheByAddr((uint32_t*)address, 4);
    return;
}
